...
echo " "
htseq-count -q ~/pool-talwar/RNA-Seq_pipeline/Mapping/$PAIR1\_STAR_out/Aligned.out.sam ~/Masters_Thesis_Project/Genomes/Mus_musculus/GRCm38/Sequence/Bowtie2Index/genome.gtf > ~/pool-talwar/RNA-Seq_pipeline/Mapping/$PAIR1\_STAR_out/$PAIR1\_count.txt
#
#
cp ~/pool-talwar/RNA-Seq_pipeline/Mapping/$PAIR1\_STAR_out/$PAIR1\_count.txt ~/pool-talwar/RNA-Seq_pipeline/Mapping/HT-Seq_counts/
#
#####                    Rename the accepted_hits.bam files
mv ~/pool-talwar/RNA-Seq_pipeline/Mapping/$PAIR1\_STAR_out/Aligned.out.sam ~/pool-talwar/RNA-Seq_pipeline/Mapping/$PAIR1\_STAR_out/$PAIR1\_Aligned.out.sam
ln -s ~/pool-talwar/RNA-Seq_pipeline/$PAIR1\_STAR_out/$PAIR1\_Aligned.out.sam ~/pool-talwar/RNA-Seq_pipeline/Mapping/featurecounts/
done
