...
echo " "
tophat2 -o ~/pool-talwar/RNA-Seq_pipeline/Mapping/$PAIR1\_tophat_out/ -p 13 -g $f3 -G ~/Masters_Thesis_Project/Genomes/Mus_musculus/GRCm38/Sequence/Bowtie2Index/genome.gtf ~/Masters_Thesis_Project/Genomes/Mus_musculus/GRCm38/Sequence/Bowtie2Index/genome $file1 ~/pool-talwar/RNA-Seq_pipeline/Quality_trimmed_files/Pair2/$PAIR2
...
#
featureCounts -a ~/Masters_Thesis_Project/Genomes/Mus_musculus/GRCm38/Sequence/Bowtie2Index/genome.gtf -o ~/pool-talwar/RNA-Seq_pipeline/Mapping/featurecounts/Complete_featurecounts.txt -T 13 -P -p -d 25 -D 101 -B -C ~/pool-talwar/RNA-Seq_pipeline/Mapping/featurecounts/*.bam
#
#
