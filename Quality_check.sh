...
fastqc -o ~/pool-talwar/RNA-Seq_pipeline/Quality_control/fastqc/ -t 13 -q $PAIR1
done
#
#
###                              now for pair2:
...
fastqc -o ~/pool-talwar/RNA-Seq_pipeline/Quality_control/fastqc/ -t 13 -q $PAIR2
done
#
echo " "
echo "`tput bold`the FastQC outputs are at : ~/pool-talwar/RNA-Seq_pipeline/Quality_control/fastqc/ `tputsgr0`"
#
#
#